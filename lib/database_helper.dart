...
class DatabaseHelper {
  ...
  static final columnRus = 'rus';
  static final columnEng = 'eng';
  static final columnShowed = 'show';
  static final columnKnow = 'know';
  static final columnLater = 'later';
  ...
  Future<List<EngRuWordsEntity>> queryAllWords() async {
    Database db = await instance.database;
